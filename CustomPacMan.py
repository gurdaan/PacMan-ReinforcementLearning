...
class GameRenderer:
    ...
    def tick(self, in_fps: int):
        ...
        while not self._done:
            ...
            # preprocess the observation using TensorFlow
            #self.obs_processed = self.preprocess_observation()
...
class Ghost(MovableObject):
    ...
    def tick(self):
        ...
        # if((int(pacman.get_position()[0])==int(self.get_position()[0])) and (int(pacman.get_position()[1])==int(self.get_position()[1]))):
        #     print("Collided")
        #     self.rewards=0
        ...
        pacman_rect = pygame.Rect(pacman.get_position(), size)
        ...
        if ghost_rect.colliderect(pacman_rect):
            ...
            self.rewards=0
            game_renderer._done=True
            # Handle the collision here (e.g. reduce Pacman's lives)

    def __init__(self, in_surface, x, y, in_size: int, in_game_controller,pacman, in_color=(255, 0, 0)):
...
if __name__ == "__main__":
    ...
    for i, ghost_spawn in enumerate(pacman_game.ghost_spawns):
        ...
        ghost = Ghost(game_renderer, translated[0], translated[1], unified_size, pacman_game,pacman,
